...
def get_mean_head_activations(dataset, model, model_config, tokenizer, n_icl_examples = 10, N_TRIALS = 100, shuffle_labels=False, prefixes=None, separators=None, filter_set=None):
    ...
    for n in range(N_TRIALS):
        word_pairs = dataset['train'][np.random.choice(len(dataset['train']),n_icl_examples, replace=True)]
        word_pairs_test = dataset['valid'][np.random.choice(filter_set,n_test_examples, replace=True)]
        if prefixes is not None and separators is not None:
...
def compute_universal_function_vector(mean_activations, model, model_config, n_top_heads=10):
    ...
    #                  (33, 28, 0.0004), (31, 11, 0.0004), (24, 28, 0.0004), (37, 7, 0.0004), (40, 7, 0.0004), (32, 61, 0.0004)]
        ...
        top_heads = [(14, 31, 1024),(14, 6, 1023),(15, 12, 1022),(14, 19, 1021),(14, 19, 1020),(15, 25, 1019),(16, 17, 1018),(16, 17, 1017),(15, 12, 1016),(11, 10, 1015),(14, 30, 1014),(15, 25, 1013),(12, 17, 1012),(16, 17, 1011),(19, 21, 1010),(18, 10, 1009),(11, 10, 1008),(31, 23, 1007),(13, 6, 1006),(18, 24, 1005),(17, 17, 1004)]
    # elif 'meta-llama/Meta-Llama-3-8B-Instruct' in model_config['name_or_path']:
    #     top_heads = [(13, 27, 1024),(15, 17, 1023),(16, 29, 1022),(10, 5, 1021),(31, 14, 1020),(16, 29, 1019),(13, 31, 1018),(10, 7, 1017),(11, 29, 1016),(12, 23, 1015),(17, 8, 1014),(12, 0, 1013),(15, 16, 1012),(14, 11, 1011),(11, 30, 1010),(15, 16, 1009),(10, 5, 1008),(31, 5, 1007),(13, 8, 1006),(31, 5, 1005),(15, 1, 1004)]
